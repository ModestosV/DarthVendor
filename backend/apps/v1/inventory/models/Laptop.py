...
class Laptop(AbstractComputer):
    ...
    """Constructor"""
    def __init__(self, modelNumber, name, weight, weightFormat, price, priceFormat, brandName, self, ramSize, ramFormat, processorType, numCores, hardDriveSize, hardDriveFormat, containCamera, isTouch, batteryInfo, os, size):
